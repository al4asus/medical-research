...
df = df.drop([
    'ilac', 'bebekadi', 'dogumtarihi', 'gebelikhaftasi', 'gebelikhaftagunu', 'gebelik_haftası_gruplu', 'tanisi',
    'tani_gruplu', 'dogum_agirligi_gruplu', 'dogumagirligi', 'cinsiyeti', 'gebelik_tipi_gruplu',
    'gebeliktipi', 'dogumyeri', 'dogumsekli', 'apgar1', 'apgar5', 'anneyas', 'polihidroamnioz', 'gebelikleht',
    'preeklampsi', 'sigara', 'antkullanimi', 'dm', 'antenatalsteroid', 'flukanazolprofilaksisi', 'steroidkullanimi',
    'lokositoz', 'trombositopeni', 'notropeni', 'idrarsondasi', 'erkenmembranrüptürü', 'erkensepsis', 'RDS',
    'gecneonatalsepsis', 'NEK', 'IKK', 'ilkhaftasolunumdestegi', 'ilkhaftainotrop', 'ilkhaftanefrotoksik',
    'nefrotoksikilacne', 'entube', 'svk', 'kankültüründebakteri', 'antifungalkullanimi',
    'cokluantibiyotikkullanimi', 'tpn', 'cerrahi', 'mantarüreme', 'astyüksekliği', 'altyüksekliği', 'hiperürisemi',
    'kreatininyüksekliği', 'procalcitonin', 'ıl6', 'crp', 'kullandıgıtarih2', 'bittiğitarih2',
    'kacgunmicafungin2', 'koryoretinit', 'endoftalmilt', 'endokardit', 'kullandıgıtarih3', 'bittigitarih3',
    'kacgunkullandi3', 'pnomotoraks', 'pda', 'annesütüalımı', 'kacgüntedavi',
    'crp1', 'crp2', 'alt1', 'alt2', 'krea1', 'krea2',
    'hb1', 'hbson', 'mpv1', 'mpvson', 'wbc1', 'wbcson', 'trombosit', 'trombositson', 'pct1', 'pctson', 'potasyum1',
    'potasyumson', 'notrofil1', 'notrofilson', 'pdw1', 'pdwson', 'ıg1', 'ıgson', 'ıl61', 'ıl6son'
], axis=1)
